package com.company.testtask.test_support;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.testtask.screen")
@ContextConfiguration(classes = {TesttaskApplication.class, UiTestAssistConfiguration.class})
